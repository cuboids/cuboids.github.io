...
The *Acelaka-vagga* then goes on to describe the middle practice in terms of the 37 factors leading to awakening (cf Gethin (1991)). But what, we may ask, is wrong with sensual pleasures? In early Buddhist thought, if attachment to sensual pleasures will necessarily lead to rebirth. From the [*Yoga-sutta*](https://suttacentral.net/an4.10/en/sujato), we have:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDAyNDUwMjMsMTA2OTU2NTg1MywtNT
...
NjIsMTU4MzUxODgxNywtMTI3NjY2MzI5OCwtODkxNzA4NTIzLD
IwMDc2MzI3NzAsLTEyNDA1MTUzNDksMjYyMzc0MDY5LDE5MTQ5
NTczMzhdfQ==
-->