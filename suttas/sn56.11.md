...
Notice how its specifically those who have gone forth who are encouraged to avoid those extremes. The parallel versions corroborate this point (Anālayo 2012, 2013). For lay practicioners it may be more difficult to avoid indulging in sensual pleasures than for mendicants. To better understand the two extremes and the middle path, I have found it helpful to read the [*Acelaka-vagga*](https://suttacentral.net/an3.156-162/en/sujato):

<blockquote><p><b>AN 3.156-162.</b> “Mendicants, there are three practices.  What three?  The addicted practice, the scorching practice, and the middle practice.</p>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjIwNjg3NjAsODEyNTQ4Njg1LDQxMT
