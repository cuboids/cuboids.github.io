...
Here we'll take a deeper look at the *Dhammacakkappavattana-sutta*. The first thing to note is that the original sutta is in Pāli, the Middle-Indo Aryan language we find in the Pali Canon. If you'd like to know more about this language, check out [the entry "Pāli Language" at the Encyclopedia Britannica](https://www.britannica.com/topic/Pali-language). The translation at [The Buddha and the Early Buddhist Teachings](https://cuboids.page.link/isd1) is from Javier Fernandez-Viña, who so far translated about a dozen-and-a-half suttas from the Pali Canon into English. His approach relies on [dynamic equivalence](https://en.wikipedia.org/wiki/Dynamic_and_formal_equivalence) and on [plain language](https://en.wikipedia.org/wiki/Plain_language), which felt quite refreshing to me: the suttas tend to be repetitive and many translations use archaic terminology. The audio files were with Google's Text-to-Speech API.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMzc4Mzg4MzQsMzg5MDA1ODc0LC0yMD
QxOTgxNDc2LC0xNzcxNDMwOSwxMDA0MDI2MjYyLC0xODM1NzEw
Njg3LC0yMDIxMDY1NjcsMTA2OTU2NTg1MywtNTU4ODI1MTE1LD
Q4NjY2Njc1Myw5ODQxNTY5NCwtMTIwNzI0NTE3MiwyMDU5MzU3
MDg5LDgxMjU0ODY4NSw0MTEwOTc2NDYsMTExNjUzMzE1LC0xMT
QwMzE4ODMyLC0xMTE5MDQ1Nzk2LC04ODE5MzUzNjIsMTU4MzUx
ODgxN119
-->